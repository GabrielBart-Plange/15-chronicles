        ...
        <main className="p-6 text-[var(--reader-text)] space-y-6">
            ...
            {stories.length === 0 ? (
                <p className="text-[var(--reader-text)]">
                    You haven't published any stories yet. Go to your <Link href="/creator/dashboard/drafts" className="text-[var(--foreground)] hover:underline">Drafts</Link> to publish one.
                </p>
            ) : (
